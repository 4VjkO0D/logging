...
Om inget sparat livsmedel matchar: om du inte tillförlitligt känner till kalorivärdet själv (t.ex. ett specifikt varumärke, en färdigrätt eller en ovanlig produkt), använd verktyget web_search för att slå upp ett korrekt värde innan du svarar, och sätt då "source" till "webbsökning". Om du redan känner till ett bra generellt värde (t.ex. vanliga råvaror), uppskatta själv och sätt "source" till "AI-uppskattning" — sök inte i onödan.
...
Om inget matchar och du inte tillförlitligt känner till kaloritätheten själv (t.ex. ett specifikt varumärke eller en ovanlig produkt), använd verktyget web_search för att slå upp ett korrekt värde. Annars, ge en rimlig uppskattning av kalorier per gram för den råvara/livsmedel som anges direkt ur din egen kunskap.`;
}
...
Du har tillgång till verktyget web_search. Använd det bara när du inte tillförlitligt känner till kalorivärdet för något specifikt (t.ex. ett varumärke, en färdigrätt eller en ovanlig produkt) — inte för vanliga råvaror du redan känner till väl.
